...
**If you'd like, please focus on Section 12 only and treat other sections in the original tutorial as extra (i.e., project-only) materials**. 

Having said that, Section 7 in the original tutorial is useful if you need a quick refresher on the log function. It will not be included in the exam.
