...
### 3.2.1 Explore the Point Estimate
...
### 3.2.2 Explore the Confidence Intervals of the Point Estimate
...
### 3.3.1 Exponentiate $\hat{\beta}$ to Get Odds Ratio (OR)
...
### 3.3.2 Use `predict()` Function (Recommended)
