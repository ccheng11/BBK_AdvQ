...
fixef(mod_lmm_beta) # fixed part of each intercept
ranef(mod_lmm_beta) # random part of each intercept
...
fixef(mod_lmm_int_beta) # fixed part of each intercept
ranef(mod_lmm_int_beta) # random part of each intercept
dotplot(ranef(mod_lmm_int_beta, condVar = TRUE))
coef(mod_lmm_int_beta)
```
